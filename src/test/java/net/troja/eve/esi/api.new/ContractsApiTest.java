...
public class ContractsApiTest {
    ...
    public void getCharactersCharacterIdContractsContractIdBidsTest() throws ApiException {
        ...
        String ifNoneMatch = null;
        String token = null;
        List<CharacterContractsBidsResponse> response = api.getCharactersCharacterIdContractsContractIdBids(characterId, contractId, datasource, ifNoneMatch, token);
    ...
    public void getCharactersCharacterIdContractsContractIdItemsTest() throws ApiException {
        ...
        String ifNoneMatch = null;
        String token = null;
        List<CharacterContractsItemsResponse> response = api.getCharactersCharacterIdContractsContractIdItems(characterId, contractId, datasource, ifNoneMatch, token);
    ...
    public void getContractsPublicBidsContractIdTest() throws ApiException {
        ...
        String ifNoneMatch = null;
        Integer page = null;
        List<PublicContractsBidsResponse> response = api.getContractsPublicBidsContractId(contractId, datasource, ifNoneMatch, page);
    ...
    public void getContractsPublicRegionIdTest() throws ApiException {
        ...
        String ifNoneMatch = null;
        Integer page = null;
        List<PublicContractsResponse> response = api.getContractsPublicRegionId(regionId, datasource, ifNoneMatch, page);
