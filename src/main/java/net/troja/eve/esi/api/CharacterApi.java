...
public class CharacterApi {
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdCall(Integer characterId, String datasource,
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdValidateBeforeCall(Integer characterId, String datasource,
        ...
        com.squareup.okhttp.Call call = getCharactersCharacterIdCall(characterId, datasource, ifNoneMatch,
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdAgentsResearchCall(Integer characterId, String datasource,
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdBlueprintsCall(Integer characterId, String datasource,
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdCorporationhistoryCall(Integer characterId,
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdFatigueCall(Integer characterId, String datasource,
            String ifNoneMatch, String token, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/characters/{character_id}/fatigue/".replaceAll("\\{format\\}", "json").replaceAll(
                "\\{" + "character_id" + "\\}", apiClient.escapeString(characterId.toString()));
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdMedalsCall(Integer characterId, String datasource,
            String ifNoneMatch, String token, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdNotificationsCall(Integer characterId, String datasource,
            String ifNoneMatch, String token, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * notifications --- This route is cached for up to 600 seconds --- Warning:
     * This route has an upgrade available --- [Diff of the upcoming
     * changes](https
     * ://esi.evetech.net/diff/latest/dev/#GET-/characters/{character_id
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdNotificationsContactsCall(Integer characterId,
            String datasource, String ifNoneMatch, String token,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        String localVarPath = "/v1/characters/{character_id}/notifications/contacts/"
                .replaceAll("\\{format\\}", "json").replaceAll("\\{" + "character_id" + "\\}",
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdNotificationsContactsValidateBeforeCall(
            Integer characterId, String datasource, String ifNoneMatch, String token,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdPortraitCall(Integer characterId, String datasource,
            String ifNoneMatch, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdRolesCall(Integer characterId, String datasource,
            String ifNoneMatch, String token, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdStandingsCall(Integer characterId, String datasource,
            String ifNoneMatch, String token, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdStatsCall(Integer characterId, String datasource,
            String ifNoneMatch, String token, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdTitlesCall(Integer characterId, String datasource,
            String ifNoneMatch, String token, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/characters/{character_id}/titles/".replaceAll("\\{format\\}", "json").replaceAll(
                "\\{" + "character_id" + "\\}", apiClient.escapeString(characterId.toString()));
    ...
    private com.squareup.okhttp.Call postCharactersAffiliationCall(List<Integer> characters, String datasource,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postCharactersAffiliationValidateBeforeCall(List<Integer> characters,
            String datasource, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postCharactersAffiliationCall(characters, datasource, progressListener,
    ...
    public List<CharacterAffiliationResponse> postCharactersAffiliation(List<Integer> characters, String datasource)
            throws ApiException {
        ApiResponse<List<CharacterAffiliationResponse>> resp = postCharactersAffiliationWithHttpInfo(characters,
                datasource);
        return resp.getData();
    }
    ...
    public ApiResponse<List<CharacterAffiliationResponse>> postCharactersAffiliationWithHttpInfo(
            List<Integer> characters, String datasource) throws ApiException {
     ...
     *             body object
     */
    public com.squareup.okhttp.Call postCharactersAffiliationAsync(List<Integer> characters, String datasource,
        ...
        com.squareup.okhttp.Call call = postCharactersAffiliationValidateBeforeCall(characters, datasource,
                progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<CharacterAffiliationResponse>>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
    ...
    private com.squareup.okhttp.Call postCharactersCharacterIdCspaCall(Integer characterId, List<Integer> characters,
    ...
    private com.squareup.okhttp.Call postCharactersCharacterIdCspaValidateBeforeCall(Integer characterId,
            List<Integer> characters, String datasource, String token,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postCharactersCharacterIdCspaCall(characterId, characters, datasource, token,
                progressListener, progressRequestListener);
        return call;
     ...
     *             deserialize the response body
     */
    public ApiResponse<Float> postCharactersCharacterIdCspaWithHttpInfo(Integer characterId, List<Integer> characters,
            String datasource, String token) throws ApiException {
        com.squareup.okhttp.Call call = postCharactersCharacterIdCspaValidateBeforeCall(characterId, characters,
     ...
     *             body object
     */
    public com.squareup.okhttp.Call postCharactersCharacterIdCspaAsync(Integer characterId, List<Integer> characters,
