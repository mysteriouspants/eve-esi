...
public class AssetsApi {
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdAssetsCall(Integer characterId, String datasource,
    ...
    private com.squareup.okhttp.Call getCorporationsCorporationIdAssetsCall(Integer corporationId, String datasource,
            String ifNoneMatch, Integer page, String token,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call postCharactersCharacterIdAssetsLocationsCall(Integer characterId,
            List<Long> itemIds, String datasource, String token,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call postCharactersCharacterIdAssetsLocationsValidateBeforeCall(Integer characterId,
        ...
        com.squareup.okhttp.Call call = postCharactersCharacterIdAssetsLocationsCall(characterId, itemIds, datasource,
                token, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<List<CharacterAssetsLocationsResponse>> postCharactersCharacterIdAssetsLocationsWithHttpInfo(
        ...
        com.squareup.okhttp.Call call = postCharactersCharacterIdAssetsLocationsValidateBeforeCall(characterId,
                itemIds, datasource, token, null, null);
    ...
    public com.squareup.okhttp.Call postCharactersCharacterIdAssetsLocationsAsync(Integer characterId,
        ...
        com.squareup.okhttp.Call call = postCharactersCharacterIdAssetsLocationsValidateBeforeCall(characterId,
                itemIds, datasource, token, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<CharacterAssetsLocationsResponse>>() {
        }.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    ...
    private com.squareup.okhttp.Call postCharactersCharacterIdAssetsNamesCall(Integer characterId, List<Long> itemIds,
    ...
    private com.squareup.okhttp.Call postCharactersCharacterIdAssetsNamesValidateBeforeCall(Integer characterId,
        ...
        com.squareup.okhttp.Call call = postCharactersCharacterIdAssetsNamesCall(characterId, itemIds, datasource,
                token, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<List<CharacterAssetsNamesResponse>> postCharactersCharacterIdAssetsNamesWithHttpInfo(
            Integer characterId, List<Long> itemIds, String datasource, String token) throws ApiException {
        com.squareup.okhttp.Call call = postCharactersCharacterIdAssetsNamesValidateBeforeCall(characterId, itemIds,
     ...
     *             body object
     */
    public com.squareup.okhttp.Call postCharactersCharacterIdAssetsNamesAsync(Integer characterId, List<Long> itemIds,
            String datasource, String token, final ApiCallback<List<CharacterAssetsNamesResponse>> callback)
            throws ApiException {
    ...
    private com.squareup.okhttp.Call postCorporationsCorporationIdAssetsLocationsCall(Integer corporationId,
            List<Long> itemIds, String datasource, String token,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = itemIds;
    ...
    private com.squareup.okhttp.Call postCorporationsCorporationIdAssetsLocationsValidateBeforeCall(
            Integer corporationId, List<Long> itemIds, String datasource, String token,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postCorporationsCorporationIdAssetsLocationsCall(corporationId, itemIds,
                datasource, token, progressListener, progressRequestListener);
        return call;
    ...
    private com.squareup.okhttp.Call postCorporationsCorporationIdAssetsNamesCall(Integer corporationId,
            List<Long> itemIds, String datasource, String token,
            final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = itemIds;
    ...
    private com.squareup.okhttp.Call postCorporationsCorporationIdAssetsNamesValidateBeforeCall(Integer corporationId,
        ...
        com.squareup.okhttp.Call call = postCorporationsCorporationIdAssetsNamesCall(corporationId, itemIds,
                datasource, token, progressListener, progressRequestListener);
        return call;
