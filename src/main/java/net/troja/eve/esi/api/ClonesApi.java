...
public class ClonesApi {
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdClonesCall(Integer characterId, String datasource,
    ...
    private com.squareup.okhttp.Call getCharactersCharacterIdImplantsCall(Integer characterId, String datasource,
            String ifNoneMatch, String token, final ProgressResponseBody.ProgressListener progressListener,
            final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/characters/{character_id}/implants/".replaceAll("\\{format\\}", "json").replaceAll(
                "\\{" + "character_id" + "\\}", apiClient.escapeString(characterId.toString()));
     ...
     * of a character --- This route is cached for up to 300 seconds SSO Scope:
     * esi-clones.read_implants.v1
     * 
     * @param characterId
     *            An EVE character ID (required)
